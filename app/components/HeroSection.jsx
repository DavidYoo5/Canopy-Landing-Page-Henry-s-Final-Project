...
export default function HeroSection() {
  ...
  const panelStyle = {
    position: phase === "after" ? "absolute" : "fixed", // always fixed except after
  ...
  const [wrapperHeight, setWrapperHeight] = useState(maxScroll);

  useEffect(() => {
    setWrapperHeight(maxScroll + window.innerHeight);
  }, []);
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse at center, transparent 40%, rgba(10, 40, 25, 0.18) 100%)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            <h1 style={headingStyle}>Finance is Stressful</h1>
          </div>
          ...
          >
            <h1 style={headingStyle}>It Doesn't Have to Be</h1>
          </div>
          ...
          >
            ...
            <h1 style={headingStyle}>Find Your Finance Shelter</h1>
          </div>
