    ...
    <div className={styles.wrapper}>
      <div className={styles.inner}>
        ...
        <div className={styles.headingArea}>
          <h2 className={styles.heading}>Unlock your special tree</h2>
          <p className={styles.subheading}>
            Hover over a tree to discover unique species from around the world
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div 
                  ...
                  style={{ background: tree.color, opacity: isActive ? 0.3 : 0.05 }} 
                />
                ...
                <div className={styles.panelContent}>
                  ...
                  <div className={`${styles.treeInfo} ${isActive ? styles.treeInfoActive : ""}`}>
                    <h3 className={styles.treeName} style={{ color: tree.color }}>
                      {tree.name}
                    </h3>
                ...
                <div className={`${styles.collapsedTitle} ${!isActive ? styles.collapsedTitleVisible : ""}`}>
